export const flapCardList = [
  {
    ...
    _g: 102,
    b: 159,
    imgLeft: 'url(' + require('common/images/gift-left.png') + ')',
    imgRight: 'url(' + require('common/images/gift-right.png') + ')',
  ...
  },
  {
    ...
    _g: 171,
    b: 255,
    imgLeft: 'url(' + require('common/images/compass-left.png') + ')',
    imgRight: 'url(' + require('common/images/compass-right.png') + ')',
    backgroundSize: '50% 50%',
    zIndex: 99,
    rotateDegree: 0
  },
  ...
  },
  {
    ...
    _g: 198,
    b: 102,
    imgLeft: 'url(' + require('common/images/star-left.png') + ')',
    imgRight: 'url(' + require('common/images/star-right.png') + ')',
    backgroundSize: '50% 50%',
    zIndex: 98,
    rotateDegree: 0
  },
  {
    ...
    _g: 102,
    b: 159,
    imgLeft: 'url(' + require('common/images/heart-left.png') + ')',
    imgRight: 'url(' + require('common/images/heart-right.png') + ')',
    backgroundSize: '50% 50%',
    zIndex: 97,
    rotateDegree: 0
  },
  {
    ...
    _g: 201,
    b: 22,
    imgLeft: 'url(' + require('common/images/crown-left.png') + ')',
    imgRight: 'url(' + require('common/images/crown-right.png') + ')',
    backgroundSize: '50% 50%',
    zIndex: 96,
    rotateDegree: 0
  }
...
export function categoryText(category, vue) {  /*图书中英文切换的国际化*/
  switch (category) {
    case 1:
