<template>
  <div class="featured">
    <title-view :label="titleText" :btn="btnText" v-if="titleVisivle && data && data.length>0"></title-view>
      ...
      <div class="featured-item-wrapper">
        <div class="featured-item" v-for="(item,index) in data" :key="index" @click="showBookDetail(item)">
          ...
          <div class="content-wrapper">
            ...
            <div class="anthor sub-title-tiny" ref="anthor">{{item.anthor}}</div>
...
<script type="text/ecmascript-6">
  import { categoryText } from "common/js/store"
