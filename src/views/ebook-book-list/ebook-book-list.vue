...
<script>
  import DetailTitle from '../ebook-detail-title/ebook-detail-title.vue'
  ...
  import { categoryList, categoryText } from 'common/js/store'
      ...
      getList() {
        list().then(response => {
          ...
          if (category) {
            ...
            this.list = {}
            this.list[key] = data
          } else if (keyword) {        /*注意这里的循环遍历的使用,针对对象*/
